...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    Actions(variables: ActionsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<ActionsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ActionsQuery>(ActionsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'Actions', 'query');
    }
  };
}
