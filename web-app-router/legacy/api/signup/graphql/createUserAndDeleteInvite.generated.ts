...
export type CreateUserAndDeleteInviteMutation = { __typename?: 'mutation_root', user?: { __typename?: 'user', id: string, team_id: string, ironclad_id: string, posthog_id?: string | null, world_id_nullifier?: string | null, auth0Id?: string | null } | null, delete_invite_by_pk?: { __typename?: 'invite', id: string } | null };


export const CreateUserAndDeleteInviteDocument = gql`
    mutation CreateUserAndDeleteInvite($team_id: String!, $nullifier: String!, $ironclad_id: String!, $invite_id: String!, $auth0Id: String!) {
  user: insert_user_one(
    object: {team_id: $team_id, world_id_nullifier: $nullifier, ironclad_id: $ironclad_id, auth0Id: $auth0Id}
  ) {
    id
    team_id
    ironclad_id
