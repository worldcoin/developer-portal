...
export type GetMembershipQuery = { __typename?: 'query_root', membership: Array<{ __typename?: 'membership', role: Types.Role_Enum }> };


export const GetMembershipDocument = gql`
    query GetMembership($user_id: String!, $team_id: String!) {
  membership(where: {_and: {team_id: {_eq: $team_id}, user_id: {_eq: $user_id}}}) {
    role
  }
}
    `;
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetMembership(variables: GetMembershipQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetMembershipQuery> {
