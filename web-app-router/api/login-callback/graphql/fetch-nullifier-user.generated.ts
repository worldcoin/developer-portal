...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    FetchNullifierUser(variables: FetchNullifierUserQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<FetchNullifierUserQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FetchNullifierUserQuery>(FetchNullifierUserDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'FetchNullifierUser', 'query');
    }
  };
}
