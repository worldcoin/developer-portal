...
const schema = yup.object({
  ...
  signal_hash: yup.string().strict().default(
    "0x00c5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a4" // hashToField("").digest to match default empty string as signal
  ),
...
export default async function handleVerify(
  ...
  const { error, success } = await verifyProof(
    {
      signal: parsedParams.signal_hash,
