...
export const HomeLayout = (props: { children: ReactNode }) => {
  return (
    <div className="grid min-h-dvh w-full grid-rows-auto/1fr bg-[#f9f9f8] font-world font-[325] text-[#181818]">
      <header className="sticky top-0 z-20 bg-[#f9f9f8]/80 backdrop-blur-md">
        <div className="relative mx-auto flex h-[58px] w-full max-w-[1728px] items-center justify-between gap-4 px-4 md:px-10 xl:px-24">
          ...
          <Link
            ...
            className="inline-flex min-w-0 items-center gap-[0.42em] py-[calc(var(--lockup-h)*14/24)] font-world text-[calc(var(--lockup-h)*0.72)] leading-none whitespace-nowrap text-[#181818] [--lockup-h:1.5rem]"
          >
            <WorldIcon
              aria-hidden
