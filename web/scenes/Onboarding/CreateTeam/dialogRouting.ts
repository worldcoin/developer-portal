...
// V3 entry point: /profile/teams redirects to /profile for v3 users (dropping
// the query), so v3 surfaces must link to the dialog on /profile directly.
export const PROFILE_CREATE_TEAM_DIALOG_URL =
