...
export const ApiKeys = (props: { teamId?: string; canWrite: boolean }) => {
  ...
  return (
    <SettingsPanel>
      ...
      {isInitialLoad ? (
        <>
          <div className="grid grid-cols-[minmax(0,1fr)_80px_32px] items-center gap-3 border-y border-edge-subtle bg-surface-faint px-5 py-2.5 font-gta text-12 leading-4 text-content-tertiary">
            <span>Name</span>
            <span>Status</span>
        ...
        <>
          ...
          />
          {apiKeys?.length === 0 ? (
            <div className="flex h-36 items-center justify-center font-gta text-13 text-content-tertiary">
              No API keys found
            </div>
          ) : null}
        </>
