...
export const LivePreview = ({
  ...
  const isLocalized = selectedLanguage !== "en";
  const { data: selectedLocaleImages } = useQuery(FetchImagesDocument, {
    variables: {
      id: appId,
      team_id: teamId,
      locale: isLocalized ? selectedLanguage : undefined,
    },
  });
  const loc =
  ...
  const showcaseUrls = isVerified
    ...
    : selectedLocaleImages?.unverified_images?.showcase_img_urls ??
      images.showcase_image_urls ??
      metadataShowcaseUrls;
