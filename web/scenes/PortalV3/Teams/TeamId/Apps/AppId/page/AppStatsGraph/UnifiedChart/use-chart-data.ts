...
import {
  ...
  FetchAppStatsQuery,
} from "@/scenes/common/Teams/TeamId/Apps/AppId/page/AppStatsGraph/graphql/client/fetch-app-stats.generated";
...
export const useChartData = (
  ...
  const formattedVerificationsChartData = useMemo(() => {
    ...
    stats.forEach((stat: FetchAppStatsQuery["app_stats"][number]) => {
