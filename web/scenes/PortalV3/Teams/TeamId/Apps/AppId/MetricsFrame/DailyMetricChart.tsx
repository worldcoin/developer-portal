    ...
    >
      ...
      {points.length === 0 ? (
        ...
        <div className="relative mt-4 aspect-video w-full pb-8 pl-12 outline-none [&_*]:outline-none">
          ...
          <span
            aria-hidden
            className="absolute top-0 bottom-8 left-0 flex w-8 items-center justify-center font-world text-12 text-portal-muted [writing-mode:vertical-rl] rotate-180"
          >
