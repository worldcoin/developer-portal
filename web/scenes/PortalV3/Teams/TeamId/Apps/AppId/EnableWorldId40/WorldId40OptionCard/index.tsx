...
export const WorldId40OptionCard = (
  ...
  const stampClassName = disabled
    ...
    : "bg-portal-accent text-content-link";
  return (
    <label
      className={twMerge(
        clsx(
          ...
          {disabled && props.disabledReason && (
            <div className="group relative">
              <span
                ...
                className="inline-flex outline-hidden focus-visible:ring-2 focus-visible:ring-edge-medium focus-visible:ring-offset-1"
              >
                <InformationCircleIcon className="size-4 text-portal-subtle" />
              </span>
              <div className="pointer-events-none absolute -top-2 right-0 z-20 w-48 -translate-y-full rounded-md bg-action px-2 py-1.5 font-world text-12 leading-[1.4] text-action-foreground opacity-0 shadow-lg transition-opacity group-focus-within:opacity-100 group-hover:opacity-100">
