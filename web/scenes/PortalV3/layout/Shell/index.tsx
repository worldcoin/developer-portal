...
/**
 * Portal shell, mounted at the portal level. The team list and user come from the
 * server session; the current team/app and per-team permissions are resolved
 * client-side (useParams + useUser) inside the dropdowns and the nav.
 */
