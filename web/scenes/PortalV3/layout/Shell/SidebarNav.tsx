                          ...
                          {miniAppItems.map((item) => (
                            <SidebarMenuSubItem key={item.href}>
                              <SidebarMenuSubButton
                                ...
                                className="h-9 cursor-pointer px-3 font-world text-portal-muted hover:bg-portal-border hover:text-portal-text data-[active=true]:bg-grey-0 data-[active=true]:text-portal-text [&>svg]:text-current"
                              >
                                <Link
                                  href={item.href}
                                  prefetch={false}
