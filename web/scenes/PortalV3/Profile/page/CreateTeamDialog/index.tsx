...
export const CreateTeamDialog = () => {
  ...
  return (
    <Dialog open={isOpen} onClose={close} appear>
      <DialogOverlay />
        ...
        <div className="border-b border-portal-border px-6 py-5">
          <div className="flex items-center justify-between gap-4">
            ...
            <button
              ...
              className="flex size-8 shrink-0 items-center justify-center rounded-8 text-portal-muted outline-hidden transition-colors hover:bg-portal-border hover:text-portal-text focus-visible:ring-2 focus-visible:ring-grey-300"
            >
