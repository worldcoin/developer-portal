...
type WorldIconProps = ComponentProps<"svg"> & {
  variant?: "solid" | "outline";
};

export const WorldIcon = (props: WorldIconProps) => {
  const { variant = "solid", ...svgProps } = props;
