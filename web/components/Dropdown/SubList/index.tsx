    ...
    <DropdownPrimitive.Portal>
      <div className="contents *:z-1000! max-md:*:pointer-events-none max-md:*:inset-0! max-md:*:transform-none!">
        <DropdownPrimitive.SubContent asChild {...otherProps}>
          ...
          >
            <div className="pointer-events-auto grid gap-y-1 rounded-t-20 border border-edge-subtle bg-surface font-gta shadow-lg max-md:mt-auto max-md:px-6 max-md:pb-8 max-md:group-data-[state=open]:animate-dropdown-content-enter-device md:mx-1 md:max-w-[20rem] md:min-w-50 md:gap-y-0 md:rounded-12 md:py-1 md:group-data-[state=open]:animate-dropdown-content-enter-desktop">
