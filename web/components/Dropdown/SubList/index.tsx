    ...
    <DropdownPrimitive.Portal>
      <div className="contents [&>*]:!z-[1000] max-md:[&>*]:pointer-events-none max-md:[&>*]:!inset-0 max-md:[&>*]:!transform-none">
        <DropdownPrimitive.SubContent asChild {...otherProps}>
          <div
            className="group data-[state=open]:animate-DropdownOverlayEnter max-md:fixed max-md:inset-0 max-md:flex max-md:flex-col max-md:overflow-y-auto max-md:bg-black/40 max-md:pt-5"
