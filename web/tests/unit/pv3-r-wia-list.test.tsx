...
it("redirects v3 users to the World ID landing, preserving deep-link params", async () => {
  await RoutePage(props());
  expect(redirect).toHaveBeenCalledWith("/teams/team_1/apps/app_1/world-id");

  await RoutePage(props({ createAction: "true" }));
  expect(redirect).toHaveBeenCalledWith(
    "/teams/team_1/apps/app_1/world-id?createAction=true",
  );
});
