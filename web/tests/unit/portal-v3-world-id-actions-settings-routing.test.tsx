...
import WorldIdActionIdSettingsPage from "../../app/(portal)/teams/[teamId]/apps/[appId]/world-id-actions/[actionId]/settings/page";

it("renders the v3 ActionId settings page for v3, not v2", async () => {
  render(
    await WorldIdActionIdSettingsPage({
