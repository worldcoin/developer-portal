...
export type AppPrecheckByActionQueryQueryVariables = Types.Exact<{
  app_id: Types.Scalars["String"]["input"];
  action: Types.Scalars["String"]["input"];
  nullifier_hash?: Types.InputMaybe<Types.Scalars["String"]["input"]>;
}>;

export type AppPrecheckByActionQueryQuery = {
...
export const AppPrecheckByActionQueryDocument = gql`
  query AppPrecheckByActionQuery(
    $app_id: String!
    $action: String!
    $nullifier_hash: String
  ) {
    app(
      ...
      actions(where: { action: { _eq: $action } }) {
        ...
        webhook_uri
        webhook_pem
        return_uri: post_action_deep_link_ios
...
export function getSdk(
  ...
  return {
    AppPrecheckByActionQuery(
      variables: AppPrecheckByActionQueryQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<AppPrecheckByActionQueryQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<AppPrecheckByActionQueryQuery>(
